...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        ...
                        <form role="form" id="update_cash_entry">
                            {!! csrf_field() !!}
                            <div class="box-body">
                                <br/>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Date" id="datepicker"
                                                  value="{{$cash_list->date}}" name="date" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Particular"
                                                   value="{{$cash_list->particular}}" name="particular" required>
                                        </div>
                                    </div>
                                    <br/>
                                    <br/>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Amount"
                                                   value="{{$cash_list->debit_amount}}"  name="debit_amount">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Amount"
                                                   value="{{$cash_list->credit_amount}}"  name="credit_amount" >
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-group">

                                            <input name="cash_id" value="{{$cash_list->id}}" type="hidden"/>
                                        </div>
                                    </div>
    ...
    <script>
        $('#update_cash_entry').on('submit', function (e) {
            e.preventDefault();
            $.ajax({
                url: "{{route('admin.user.cash_entry.list.update')}}",
                method: "POST",
